...
!/ ------------------------------------------------------------------- /  
      SUBROUTINE UOST_SRCTRM(IP, SPEC, CG, U10ABS, U10DIR, IMATRA, IMATDA)
!/
!/                  +-----------------------------------+
!/                  | WAVEWATCH III           NOAA/NCEP |
!/                  |          Lorenzo Mentaschi        |
...
!/ ------------------------------------------------------------------- /
      ...
      REAL(rkind), INTENT(INOUT) :: IMATRA(SRCTRM%SGD%NK, SRCTRM%SGD%NTH), IMATDA(SRCTRM%SGD%NK, SRCTRM%SGD%NTH)
      INTEGER :: IPGLOB
!/S      INTEGER, SAVE           :: IENT   = 0

!/S      CALL STRACE (IENT, 'UOST_SRCTRM') 

      IPGLOB = iplg(IP)
      CALL SRCTRM%COMPUTE(IPGLOB, 1, SPEC, CG, U10ABS, U10DIR, IMATRA, IMATDA)
...
!/ ------------------------------------------------------------------- /  
      ...
      SUBROUTINE UOST_SOURCETERM_COMPUTE(THIS, IX, IY, SPEC, CG, U10ABS, U10DIR, IMATRA, IMATDA)
!/
!/                  +-----------------------------------+
!/                  | WAVEWATCH III           NOAA/NCEP |
!/                  |          Lorenzo Mentaschi        |
